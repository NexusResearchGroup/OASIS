...
public class aboutTextbox extends Panel
{
    int panelWidth=300 ; 
    int panelHeight=150 ;
    Label title = new Label("Intersection Signal Control") ;
    //Label title = new Label("Virtual Traffic Signal Controller") ;
    //SHARED share = new SHARED();
    String verStr = SHARED.VERSION ; 
    Label ver = new Label(verStr) ;
    //Label org = new Label("ITS Lab, ITS Institute, University of Minnesota") ;
    Label org = new Label("Minnesota Traffic Observatory (MTO), U of MN") ;

    aboutTextbox()
    {
	setBackground(new Color(255, 255, 0)) ; //128,255,255));
